"""
Django settings for spider_pet_43761 project.
...
ROOT_URLCONF = 'spider_pet_43761.urls'
...
WSGI_APPLICATION = 'spider_pet_43761.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spider_pet_43761 API",
    "DESCRIPTION": "API documentation for spider_pet_43761 App",
    "VERSION": "v1",
}
